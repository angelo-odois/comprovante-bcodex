...
async function createAnaUser() {
  console.log('🆕 Criando usuário ana.livia@bcodex.io...\n');

  try {
    // Dados do usuário
    const email = 'ana.livia@bcodex.io';
    const fullName = 'Ana Livia';
    const companyName = 'BCodex';
    const password = '3C0dex@25';
    ...
    console.log('\n🎉 Usuário Ana Livia criado com sucesso!');
    console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
    console.log(`📋 ID: ${user.id}`);
    console.log(`📧 Email: ${user.email}`);
    console.log(`👤 Nome: ${user.full_name}`);
    console.log(`🏢 Empresa: ${user.company_name}`);
    console.log(`🔐 Senha: 3C0dex@25`);
